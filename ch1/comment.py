...
print("%d" % 100)
print("%5d" % 100)   #5자리 맞춰서 출력 (오른쪽 기준)
print("%05d" % 100)  #5자리 맞춰서 출력 (자릿수 없는 것은 0으로 채우기)
print()
print("%s" % "hi")
print("%5s" % "hi")
print()
print("%-8.2f" % 123.21)     # -가붙어서 왼쪽 정렬
print("%8.2f" % 123.21)      # 8.2 < 8 전체 8자리수
print("%8.2f" % 123.213456)  # 8.2 < 2자리수까지만 나오게하기때문에 123.21이 나온다
...
print("%d : %s" % (1, "홍길동")) #여러개가 개입될때는 () 를 써야한다
